...
const contactItems = [
    { icon: "geo-alt", text: "Taman Sari, Curug Nangka" },
    { icon: "telephone", text: "081234567890" },
    { icon: "envelope", text: "villa.com" },
];
        ...
        <footer id="contact" className="bg-light py-4">
            <div className="container">
                <div className="row">
                    <div className="col-md-4 mb-3">
                        ...
                        <p className="text-muted">
                            Your trusted villa bookings since 2026
                        </p>
                ...
                <div className="text-center text-muted">
                    <p className="mb-0">&copy; 2024 Abrar Fahad. All rights
                        reserved.</p>
                </div>
            </div>
        </footer>
